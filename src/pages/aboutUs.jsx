...
import comboImg from "../images/Mobite-Combo-Pack-Pukal-Foods-300x300.png";
...
export default function AboutUs() {
  const sections = {
    vision: {
      title: "Our Vision",
      content:
        "To become India's most loved baked snack brand, bringing joy, taste, and quality to every bite while promoting better snacking choices for all.",
    },
    mission: {
      title: "Our Mission",
      content:
        "Mobite offers high-quality, delicious snacks crafted for every lifestyle. With a unique taste and premium quality, our snacks bring people together, creating memorable and enjoyable moments with every bite.",
    },
    about: {
      title: "About Us",
      content:
