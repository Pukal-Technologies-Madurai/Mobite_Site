...
const CHAT_RESPONSES = {
  ...
  greetings: {
    ...
    responses: [
      ...
      "Hello! Welcome to Mobite. What can I assist you with?",
  ...
  help: {
    ...
    responses: [
      ...
      "Sure, I'm here to help! What would you like to know about Mobite?",
  ...
  products: {
    ...
    productLinks: ["https://www.mobite.in/products"],
  },
  contact: {
...
const CHAT_CONSTANTS = {
  INITIAL_MESSAGE: "Welcome to Mobite! Thank you for visiting us.",
  DEBOUNCE_DELAY: 100,
  ANIMATION_DELAY: 300,
  HOME_RESPONSE: "Welcome back to the main menu!",
  PRODUCT_RESPONSE: "Here are our available products at Mobite.",
  SUGGESTION_SETS: {
